...
from pymcuprog.utils import read_target_voltage, read_supply_voltage_setpoint, read_usb_voltage
from pymcuprog.utils import set_supply_voltage_setpoint
...
DEVICE_FOLDER = os.path.dirname(os.path.abspath(__file__)) + "//devices//"
