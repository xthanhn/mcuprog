...
from pymcuprog.deviceinfo.deviceinfokeys import DeviceMemoryInfoKeys, DeviceInfoKeys, DeviceInfoKeysPic
...
def get_supported_devices():
    ...
    """
    #print("test get supported device")
