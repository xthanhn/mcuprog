...
from pymcuprog.pymcuprog_errors import PymcuprogNotSupportedError, PymcuprogSessionConfigError
from pymcuprog.pymcuprog_errors import PymcuprogError
from pymcuprog.nvm import get_nvm_access_provider
from pymcuprog.deviceinfo.memorynames import MemoryNameAliases
from pymcuprog.deviceinfo.deviceinfokeys import DeviceInfoKeysPic, DeviceMemoryInfoKeys
...
class Programmer:
    ...
    def load_device(self, device_name):
        ...
        """
        #print("[d]load_device: ", device_name)
        ...
        try:
            ...
            #print("[d]load_device: unable to find device info")
