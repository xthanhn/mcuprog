...
from pymcuprog.utils import print_tool_info, showdata, verify_from_bin, compare
...
try:
    from pymcuprog.version import VERSION, BUILD_DATE, COMMIT_ID
except ImportError:
    VERSION = "0.0.0"
    COMMIT_ID = "N/A"
    BUILD_DATE = "N/A"
